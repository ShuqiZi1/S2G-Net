...
from src.config.hyperparameters.best_parameters import lstmgnn, dynamic, ns_gnn_default, mamba_gps_default, mamba_default
...
def init_arguments():
    ...
    parser.add_argument('--model', type=str, choices=['lstm', 'lstmgnn', 'gnn', 'mamba', 'graphgps', 'mamba-gps'], default='lstmgnn')
